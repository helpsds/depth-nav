# Depth-Nav: Depth-Enhanced Visual Navigation

Depth-Nav is a depth-enhanced visual navigation framework built upon
Visual Navigation Transformer. It introduces monocular depth information
generated by Depth Anything 3 into GNM/ViNT-based navigation models.

The framework jointly encodes RGB observations, depth features, and
near-obstacle risk information. These multimodal features are fused to
predict goal distance and future navigation actions.

The project is designed for robot navigation in complex environments,
especially scenes containing occlusions, narrow passages, and nearby
obstacles. Its main objective is to improve geometric perception and
collision-awareness while retaining the generalization capability of
goal-conditioned visual navigation models.
